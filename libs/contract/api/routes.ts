...
export const REST_API = {
    CAMOUFLAGE_DOMAIN: {
        VALIDATE: `${ROOT}/${CONTROLLERS.CAMOUFLAGE_DOMAIN_CONTROLLER}/${CONTROLLERS.CAMOUFLAGE_DOMAIN_ROUTES.VALIDATE}`,
    },
    MIERU: {
        START: `${ROOT}/${CONTROLLERS.MIERU_CONTROLLER}/${CONTROLLERS.MIERU_ROUTES.START}`,
        STOP: `${ROOT}/${CONTROLLERS.MIERU_CONTROLLER}/${CONTROLLERS.MIERU_ROUTES.STOP}`,
        STATUS: `${ROOT}/${CONTROLLERS.MIERU_CONTROLLER}/${CONTROLLERS.MIERU_ROUTES.STATUS}`,
    },
    XRAY: {
